<div class="bg-white/90 backdrop-blur-xl rounded-[32px] p-8 md:p-10 shadow-2xl shadow-slate-200/50 border border-white">
    <div class="space-y-8">
        ...
        <div class="pt-6 flex justify-between gap-4 border-t border-slate-50">
            ...
            <x-button wire:click="save" wire:loading.attr="disabled" wire:target="save, id_proof, transcript" color="primary" class="h-12 px-10 rounded-xl font-black uppercase tracking-[0.2em] text-[10px] shadow-xl shadow-primary-200 hover:translate-y-[-2px] transition-all" right-icon="arrow-right">

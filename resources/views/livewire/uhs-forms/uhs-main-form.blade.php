<div class="w-full mx-auto py-4 px-2 sm:px-4 lg:px-6 font-sans">
    <div class="bg-slate-900/90 backdrop-blur-2xl rounded-3xl shadow-2xl overflow-hidden mb-8 p-6 md:p-10 lg:p-12 space-y-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between border-b border-slate-800 pb-6">
            ...
            <div class="mt-4 md:mt-0 flex items-center space-x-3">
                <div class="px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 text-xs font-semibold">
                    Step {{ $step == 5 ? 4 : ($step == 6 ? 5 : ($step == 7 ? 6 : $step)) }} of 6
                </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-6 gap-2">
            ...
            {{-- Step 4 (Admission Test) hidden — preserved for future use, set BYPASS_ADMISSION_TEST=false in config to re-enable --}}
        ...
        <div class="bg-slate-950/60 rounded-2xl p-6 md:p-10 lg:p-14 shadow-inner">
            @if ($step == 1)
